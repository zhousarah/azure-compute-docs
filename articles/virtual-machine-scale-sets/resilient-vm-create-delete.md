---
title: Enabling resiliency when creating and deleting VMs in a Virtual Machine Scale Sets (Preview)
description: UPDATE - Learn how to create a standby pool to reduce scale-out latency with Virtual Machine Scale Sets.
author: manasisoman
...
# Enabling resiliency when creating and deleting VMs in a Virtual Machine Scale Sets (Preview)
