...
### September 2024
Automatic triggers will be deactivated if the image template build has failed for more than 50 times in a row, in order to avoid unnecessary failed builds.
