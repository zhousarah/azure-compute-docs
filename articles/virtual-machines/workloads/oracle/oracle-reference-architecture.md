...
Data Guard can be deployed using Fast Start Failover (FSFO) also known as Data Guard Broker Configuration. This feature allows you to automatically fail- and switchover in case of failure. 
