...
ms.custom:
  ...
  - ignite-2023
---
- Premium SSD v2 can be used with any premium storage-enabled [virtual machine size](../articles/virtual-machines/sizes/overview.md). Navigate to your desired virtual machines (VMs) size article to determine support for premium storage.
