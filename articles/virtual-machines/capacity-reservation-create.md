...
To create a zonal Capacity Reservation Group, see below ARM Template. Replace the resource names with your own. The following example creates capacity reservations in all three zones.
