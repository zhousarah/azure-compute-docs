...
- The subscription must have available quota equal to or more than the quantity of VMs being reserved for the VM series and for the region overall. If needed, [request more quota](azure-docs-pr/quotas/per-vm-quota-requests.md). 
