...
|---|---|---|---|
|**AlmaLinux**|[AlmaLinux OS (AArch64/ARM64)](https://azuremarketplace.microsoft.com/marketplace/apps/almalinux.almalinux-arm?tab=Overview)|Microsoft CSS provides commercially reasonable support for these images.|AlmaLinux OS is the ONLY 100% community owned and governed, open source and forever free enterprise-grade Linux distribution. Focused on long-term stability and providing a robust production-grade platform, AlmaLinux OS is 1:1 compatible with RHEL/CentOS.|
