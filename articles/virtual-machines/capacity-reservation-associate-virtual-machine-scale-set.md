...
To associate a virtual machine scale set with Capacity Reservation Group, see below ARM Template. Replace the resource names with your own. The following example creates a virtual machine of SKU D2s_v3 and associates to a capacity reservation group.
