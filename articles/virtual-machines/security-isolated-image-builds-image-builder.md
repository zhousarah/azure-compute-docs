...
> [!NOTE]
> To access the live logs during the image build or the `customization.log` file after the build is complete, please refer to the [troubleshooting guide](./linux/image-builder-troubleshoot.md#accessing-live-logs-during-image-build).
