...
** Note that Bandwidth is shared between Storage and Network

**VHM VM Skus are Full node skus offered with Isolated features Isolation for VMs in Azure - Azure Virtual Machines | Microsoft Docs

1 Mv3-series VHM VMs are generation 2 only and support a subset of generation 2 supported OS Images.  We will update the supported OS list later in the program. Current targets are 

•Windows Server 2023 SP1 latest builds

•SUSE Linux enterprise Server 15 SP4 and later

•Red Hat Enterprise Linux 8.6 or later
