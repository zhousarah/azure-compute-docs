...
1. Under **Administrator account**, enter a username and a password.
...
1. In the **Capacity Reservations** dropdown list, select the capacity reservation group that you want the VM to be associated with.
...
An [Azure Resource Manager template (ARM template)](../../azure-docs-pr/resource-manager/templates/overview.md) is a JavaScript Object Notation (JSON) file that defines the infrastructure and configuration for your project. The template uses declarative syntax. In declarative syntax, you describe your intended deployment without writing the sequence of programming commands to create the deployment.
...
1. In the **Capacity Reservation group** dropdown list, select the group that you want the VM to be associated with.
